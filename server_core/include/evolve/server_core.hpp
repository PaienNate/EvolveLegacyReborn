...
struct ServerConfig {
  ...
  std::filesystem::path asset_root = "EvolveCrack";
  std::filesystem::path ca_certificate_path = "certs/mitmproxy-ca-cert.pem";
  std::filesystem::path ca_private_key_path = "certs/mitmproxy-ca.pem";
